...
## Example 4
## Use HUE channel to do Histogram Backprojection and Mean Shift tracking
## Use builtin cv2.selectROI (introduced in OpenCV 3.1) to locate the initial search window

## Codes adapted from http://docs.opencv.org/trunk/db/df8/tutorial_py_meanshift.html
